...
class PPO_discrete():
    ...
    def load(self, episode):
        self.critic.load_state_dict(torch.load("./model/ppo_critic{}.pth".format(episode), map_location=self.device, weights_only=True))
        self.actor.load_state_dict(torch.load("./model/ppo_actor{}.pth".format(episode), map_location=self.device, weights_only=True))